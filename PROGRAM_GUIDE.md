...
- ตารางหลักเป็น Compact layout 12 คอลัมน์และแสดง Input/ผลคำนวณในตารางเดียว
  โดย `Assigned Inverter` อยู่ถัดจาก `เลือก Inverter`
- ใช้ปุ่ม **ดาวน์โหลด Excel Paste Pattern (CSV)** เพื่อเปิด Pattern ใน Excel
  และคงคอลัมน์ `string_kwp`/`assigned_inverter` เป็นช่องว่างก่อน Copy แถวข้อมูล
  วิธีนี้ทำให้ข้อมูล 12 คอลัมน์ตรงกับตารางและไม่เลื่อนขณะ Paste
